...
作業の完了状態を「ToDo」や「Done」で示すなどしても、虚偽報告をしてくる。（Claude-3.5-sonnet
でも）

> やってる風の例） ![](/images/2025-02-9bce91b10c2487-noaction.png)
...
ユーザーインプットを考えると、 **「プロンプトが指示である」**
ケースが多いであろう。 一方、僕が取り組んでいるのは、
**「プロンプトは、Schemaを解釈してJSONを読み、読んだ結果が指示なので従って（コマンドだったら実行して）、という指示である」**
ので、若干わかりにくい。
