...
traceability:
  ...
  - id:
      full: req:api:deepres-summary-4b7c2e#20250909
      level: req
      scope: api
      semantic: deepres-summary
      hash: 4b7c2e
      version: 20250909
    summary: サマリー
    description: DeepResearch機能の概要説明
    author: system
    derived_from: []
    trace_to: []
    status: draft
    tags: []
  - id:
      full: req:api:connection-5d9a3f#20250909
      level: req
      scope: api
      semantic: connection
      hash: 5d9a3f
      version: 20250909
    summary: DeepResearch API連携要求
    description: API接続管理、リクエスト処理、エラーハンドリング
    author: system
    derived_from: []
    trace_to: []
    status: draft
    tags: []
  - id:
      full: req:api:research-exec-6e2b4a#20250909
      level: req
      scope: api
      semantic: research-exec
      hash: 6e2b4a
      version: 20250909
    summary: 調査実行機能要求
    description: 調査タスク管理、情報源管理、結果処理
    author: system
    derived_from: []
    trace_to: []
    status: draft
    tags: []
  - id:
      full: req:api:prompt-mgmt-7f3c5b#20250909
      level: req
      scope: api
      semantic: prompt-mgmt
      hash: 7f3c5b
      version: 20250909
    summary: プロンプト管理要求
    description: プロンプトテンプレート、ライブラリ、最適化機能
    author: system
    derived_from: []
    trace_to: []
    status: draft
    tags: []
  - id:
      full: req:api:tenant-data-8a4d6c#20250909
      level: req
      scope: api
      semantic: tenant-data
      hash: 8a4d6c
      version: 20250909
    summary: テナントデータ管理要求
    description: データ分離、調査結果の保存、データ組織化
    author: system
    derived_from: []
    trace_to: []
    status: draft
    tags: []
  - id:
      full: req:api:data-utilize-9b5e7d#20250909
      level: req
      scope: api
      semantic: data-utilize
      hash: 9b5e7d
      version: 20250909
    summary: データ活用機能要求
    description: 検索と発見、分析機能、エクスポート機能
    author: system
    derived_from: []
    trace_to: []
    status: draft
    tags: []
  - id:
      full: req:api:integration-ac6f8e#20250909
      level: req
      scope: api
      ...
      version: 20250909
    summary: 統合機能要求
    description: 他機能との連携、ワークフロー自動化、外部連携
    author: system
    derived_from: []
    trace_to: []
    status: draft
    tags: []
  - id:
      full: req:api:security-bd7a9f#20250909
      level: req
      scope: api
      semantic: security
      hash: bd7a9f
      version: 20250909
    summary: セキュリティとコンプライアンス要求
    description: アクセス制御、データガバナンス、品質管理
    author: system
    derived_from: []
    trace_to: []
    status: draft
