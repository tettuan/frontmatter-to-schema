...
5. 要求フローを実行シミュレーション: 「要求実行案」を2つシミュレーション実行する
6. 要求フローを実行シミュレーション:
...
8. 設計調査と実装調査の比較評価:
   評価した結果が、要求・要件を満たしているか判定する
9. 設計調査と実装調査の比較評価:
   判定結果に基づいて、テストが実装されているか調べる。
   テストには、`inspector-debug plan-logger debug-strategy` で示す
   BreakdwonLogger 戦略を組み込む。
10. 設計調査と実装調査の比較評価:
