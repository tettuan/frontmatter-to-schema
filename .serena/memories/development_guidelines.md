...
- Interfaces: PascalCase with descriptive names (e.g., `AnalysisStrategy`, `FrontMatterExtractor`)
- Generic Types: Use descriptive type parameters (e.g., `<TInput, TOutput>`, `<TSchema, TResult>`)
...
- **Value Objects**: Immutable objects with behavior (FilePath, FrontMatterContent)
