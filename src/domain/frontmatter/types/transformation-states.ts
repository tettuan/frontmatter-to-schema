...
export type ValidationState =
  ...
  | { kind: "validation_failed"; data: unknown; errors: Array<DomainError & { message: string }> };
...
export type TransformationProgressState =
  ...
  | { kind: "processing"; processedCount: number; totalFiles: number; currentFile: string }
  | { kind: "aggregating"; processedData: FrontmatterData[] }
  | { kind: "completed"; result: FrontmatterData; processedCount: number }
  | { kind: "failed"; error: DomainError & { message: string }; processedCount: number };
...
export type MemoryMonitoringState =
  ...
  | { kind: "approaching_limit"; heapUsed: number; warningThreshold: number; limit: number }
...
export type DocumentProcessingResult =
  | { kind: "success"; data: FrontmatterData; document: import("../entities/markdown-document.ts").MarkdownDocument }
  | { kind: "skipped"; reason: string; filePath: string }
  | { kind: "failed"; error: DomainError & { message: string }; filePath: string };
...
export type SchemaResolutionState =
  ...
  | { kind: "resolved"; schema: import("../../schema/entities/schema.ts").Schema }
...
export namespace StateTransitions {
  ...
  export function updateProgress(
    ...
    event:
      ...
      | { type: "file_failed"; file: string; error: DomainError & { message: string } }
