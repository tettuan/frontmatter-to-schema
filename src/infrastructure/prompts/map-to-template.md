...
You are mapping extracted data to a specific template structure according to a
provided schema.
...
1. Transform the extracted data to match the exact structure defined in the
   schema
...
4. Remove any fields not defined in the schema (unless schema allows
...
Return the mapped data as a valid JSON object that exactly matches the schema
structure.
