...
- [ ] Replace 2 console statements in tests/integration/analysis-pipeline.test.ts
- [ ] Replace 1 console statement in tests/integration/end-to-end-pipeline.test.ts
