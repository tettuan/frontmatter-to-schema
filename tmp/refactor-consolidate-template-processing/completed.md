...
- ✅ ドメインイベント（`TemplateLoaded`, `TemplateApplied`,
  `TemplateProcessingFailed`）を実装
...
- `src/infrastructure/template/file-template-repository.ts` - File-based
  Repository実装
