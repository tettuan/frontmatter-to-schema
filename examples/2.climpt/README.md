...
This example demonstrates processing climpt prompts into a registry format using the frontmatter-to-schema tool.
...
- `x-frontmatter-part: true` - Processes each markdown file as a separate command
