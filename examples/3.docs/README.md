...
This example demonstrates multi-level documentation processing with spec-trace functionality.
...
- **Multi-level processing**: Different schemas for different documentation levels
